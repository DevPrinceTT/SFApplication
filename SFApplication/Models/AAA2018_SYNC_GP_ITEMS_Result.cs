...
namespace SFApplication.Models
{
    ...
    public partial class AAA2018_SYNC_GP_ITEMS_Result
    {
        ...
        public string ITEMNMBR1 { get; set; }
        public string VENDORID { get; set; }
        public Nullable<short> ITMVNDTY { get; set; }
        public string VNDITNUM { get; set; }
        public Nullable<decimal> QTYRQSTN { get; set; }
        public Nullable<decimal> QTYONORD { get; set; }
        public Nullable<decimal> QTY_Drop_Shipped { get; set; }
        public Nullable<System.DateTime> LSTORDDT { get; set; }
        public Nullable<decimal> LSORDQTY { get; set; }
        public Nullable<decimal> LRCPTQTY { get; set; }
        public Nullable<System.DateTime> LSRCPTDT { get; set; }
        public Nullable<decimal> LRCPTCST { get; set; }
        public Nullable<int> AVRGLDTM { get; set; }
        public Nullable<short> NORCTITM { get; set; }
        public Nullable<decimal> MINORQTY { get; set; }
        public Nullable<decimal> MAXORDQTY { get; set; }
        public Nullable<decimal> ECORDQTY { get; set; }
        public string VNDITDSC { get; set; }
        public Nullable<decimal> Last_Originating_Cost { get; set; }
        public string Last_Currency_ID { get; set; }
        public Nullable<short> FREEONBOARD { get; set; }
        public string PRCHSUOM1 { get; set; }
        public Nullable<short> CURRNIDX { get; set; }
        public Nullable<short> PLANNINGLEADTIME { get; set; }
        public Nullable<decimal> ORDERMULTIPLE { get; set; }
        public string MNFCTRITMNMBR { get; set; }
        public Nullable<int> DEX_ROW_ID1 { get; set; }
    }
}
